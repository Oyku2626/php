...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 24 Haz 2025, 14:03:13
...
INSERT INTO `lectures` (`id`, `name`, `email`, `password_hash`, `created_at`) VALUES
...
ALTER TABLE `room_reservations`
  ...
  ADD KEY `lecturer_3` (`lecturer`),
  ADD KEY `room_id_3` (`room_id`),
  ADD KEY `lecturer_4` (`lecturer`),
